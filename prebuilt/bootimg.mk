...
$(INSTALLED_RAMDISK_TARGET): $(MKBOOTFS) $(INTERNAL_RAMDISK_FILES) | $(MINIGZIP)
	...
	cmp -s device/qumo/q510/rootdir/custom_init $(PRODUCT_OUT)/root/init; \
	RETVAL=$$?; \
	if [ $$RETVAL -eq 1 ]; then \
		mv $(PRODUCT_OUT)/root/init $(PRODUCT_OUT)/root/init2; \
		cp device/qumo/q510/rootdir/custom_init $(PRODUCT_OUT)/root/init; \
	fi
